...
BEGIN_MESSAGE_MAP(CMFCApplication1App, CWinApp)
	...
	ON_COMMAND(ID_DLG_TEST, &CMFCApplication1App::OnDlgTest)
END_MESSAGE_MAP()
...
void CMFCApplication1App::OnDlgTest()
{
	// TODO: 여기에 명령 처리기 코드를 추가합니다.
	//CDLG_TEST1 dlg; dlg.DoModal(); 아래코드랑 같음
	CDLG_TEST1* dlg = new CDLG_TEST1();
	dlg->DoModal();
}
